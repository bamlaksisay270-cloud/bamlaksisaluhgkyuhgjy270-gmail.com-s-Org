...
export const FinancePortal: React.FC<FinancePortalProps> = ({
  ...
  const [amountRequestedEtb, setAmountRequestedEtb] = useState('150000');
  const [purpose, setPurpose] = useState('Purchase certified hybrid seed & solar drip irrigation for 3 hectare expansion');
  const [targetCrop, setTargetCrop] = useState('Roma Tomatoes & Sweet Bell Peppers');
  const [expectedYieldTons, setExpectedYieldTons] = useState('18');
  const [expectedRevenueEtb, setExpectedRevenueEtb] = useState('850000');
