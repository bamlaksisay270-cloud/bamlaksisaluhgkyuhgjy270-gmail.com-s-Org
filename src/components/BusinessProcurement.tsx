...
export const BusinessProcurement: React.FC<BusinessProcurementProps> = ({
  ...
  // Form State
  const [productName, setProductName] = useState('Bulk Roma Tomatoes (Processing Grade)');
  ...
  const [targetPriceEtb, setTargetPriceEtb] = useState('55000');
  const [deliveryDate, setDeliveryDate] = useState('2026-09-20');
  const [deliveryLocation, setDeliveryLocation] = useState('Ethiopian Skylight Hotel Central Cold Storage, Addis Ababa');
