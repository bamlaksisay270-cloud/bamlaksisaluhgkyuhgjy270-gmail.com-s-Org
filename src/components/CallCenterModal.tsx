      ...
      >
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            {/* Offline USSD Access */}
            <div className="bg-gradient-to-br from-amber-950/90 to-zinc-900 border border-amber-800/50 rounded-2xl p-4 text-white flex flex-col justify-between shadow-xs">
              <div>
                <div className="flex items-center justify-between">
                ...
                <p className="text-2xl font-black text-amber-300 mt-1 font-mono tracking-wider">
                  *6112#
                </p>
                <p className="text-[11px] text-zinc-300 mt-0.5">
                  Dial from any Ethio Telecom or Safaricom phone to list crops, check prices & receive payments.
                </p>
              </div>
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full py-2.5 px-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-zinc-950 text-xs font-black flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-sm"
                >
                  <Smartphone className="h-4 w-4" />
                  <span>Launch USSD Simulator</span>
                </button>
              </div>
            </div>
          </div>
