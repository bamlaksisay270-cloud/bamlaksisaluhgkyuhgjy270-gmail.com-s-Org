...
export const products = pgTable('products', {
  ...
  grade: text('grade').notNull().default('GRADE_1_EXPORT'), // GRADE_1_EXPORT, GRADE_1_LOCAL, GRADE_2_COMMERCIAL, PROCESSING_GRADE
  pricePerUnitEtb: doublePrecision('price_per_unit_etb').notNull(),
  unit: text('unit').notNull().default('KG'), // KG, QUINTAL, CRATE, BAG, TON, PIECE
  ...
  status: text('status').notNull().default('ACTIVE'), // ACTIVE, PAUSED, OUT_OF_STOCK
